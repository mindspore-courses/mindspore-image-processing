...
def main():
    ...
    metrics = EvalCOCOMetric(coco=data_loader.coco,
                             classes_mapping=coco80_to_91)
    ...
    for i in tqdm(range(len(data_loader))):
        ...
        # post-process
        result = non_max_suppression(mindspore.Tensor(
            result), conf_thres=0.001, iou_thres=0.6, multi_label=True)[0]
