...
class VOCDataSet():
    ...
    def __getitem__(self, idx):
        ...
        boxes = mindspore.Tensor(boxes, dtype=mindspore.float32)
        labels = mindspore.Tensor(labels, dtype=mindspore.int64)
        iscrowd = mindspore.Tensor(iscrowd, dtype=mindspore.int64)
        image_id = mindspore.Tensor([idx])
    ...
    def coco_index(self, idx):
        ...
        # convert everything into a mindspore.Tensor
        boxes = mindspore.Tensor(boxes, dtype=mindspore.float32)
        labels = mindspore.Tensor(labels, dtype=mindspore.int64)
        iscrowd = mindspore.Tensor(iscrowd, dtype=mindspore.int64)
        image_id = mindspore.Tensor([idx])
